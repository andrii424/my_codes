...
def find_max(lst, key):
    ...
    # Проходим по списку и записываем индексы элементов с наименьшим или наибольшим значением
    for i, val in enumerate(lst):
        if val == max_value:
            max_indices.append(i)
    # Возвращаем значение наименьшего или наибольшего элемента и список его индексов
    return max_value, max_indices  


max_value, max_indices = find_max(lst, "min")


# Результаты 1
if len(max_indices) > 1:
    print(f"Наименьшие элементы: {max_value} с индексами {max_indices}")
else:
    print(f"Наименьший элемент: {max_value} с индексом {max_indices[0]}")

_value, extreme_indices = find_max(lst, "max")

# Результаты 2
if len(max_indices) > 1:
    print(f"Наибольшие элементы: {max_value} с индексами {max_indices}")
else:
    print(f"Наибольший элемент: {max_value} с индексом {extreme_indices[0]}")